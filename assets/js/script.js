...
var question1 = ["1.Of the following, if statements, which one correctly executes three instructions if the condition is true?", 
"If (x < 0) a = b * 2; y = x; z = a – y;", 
"{ if (x < 0) a = b * 2; y = x; z = a – y; }", 
"If{ (x < 0) a = b * 2; y = x; z = a – y ; }", 
"If (x < 0) { a = b * 2; y = x; z = a – y; }", 
"If (x < 0) { a = b * 2; y = x; z = a – y; }"]//answer is last choice
var question2 = ["2.Kim has just constructed her first for loop within the Java language.  Which of the following is not a required part of a for loop?", 
"Initialization", 
"Condition", 
") increment",  
"Variable"]
var question3 = ["3.Sal needs to execute a section of code ten times within a program. Compare the selection structures below and select which one meets the needs identified.", 
"if-Else",  
"While", 
"If", 
"For"]
var question4 = ["4.Which command will stop an infinite loop?", 
"Alt-C", 
"Shift-C", 
"Esc", 
"Ctrl-C"]
var question5 = ["5.Which of the sets of statements below will add 1 to x if x is positive and subtract 1 from x if x is negative but leave x alone if x is 0?", 
"If (x > 0) x++; else x--;", 
"If (x > 0) x++; else if (x < 0) x--;", 
"X++; x--;", 
"If (x == 0) x = 0; else x++; x--;"]
var question6 = ["6.During program development, software requirements specify", 
        ...
        function rightAnswer() {
            ...
            nextQuestion()
                ...
                function endScreen() {
                    ...
                    score.innerHTML = "You answered " + correctAnswer + " out of 6 correct."
